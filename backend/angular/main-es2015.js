...
let AdminCoursesComponent = class AdminCoursesComponent {
    constructor(coursesService, route, authService) {
    ...
    ngOnInit() {
        ...
        this.coursesSub = this.coursesService
            ...
            this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](courses);
...
AdminCoursesComponent.ctorParameters = () => [
...
let AdminEnquiriesComponent = class AdminEnquiriesComponent {
    constructor(enquiryService, route, authService) {
    ...
    ngOnInit() {
        ...
        this.enquiriesSub = this.enquiryService
            ...
            this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](enquiries);
            this.dataSource.paginator = this.paginator;
            this.dataSource.sort = this.sort;
        });
    }
...
AdminEnquiriesComponent.ctorParameters = () => [
...
let AdminOrdersComponent = class AdminOrdersComponent {
    constructor(http, ordersService, authService) {
        this.http = http;
...
let AdminComponent = class AdminComponent {
    ...
    ngOnInit() {
        ...
        this.http.get('http://localhost:3000/api/orders').subscribe(data => this.orders = [...data]);
    }
    totalEarnings(orders) {
        return orders.reduce((acc, cur) => acc + this.orderTotal(cur.items), 0);
    }
...
let CourseFormComponent = class CourseFormComponent {
    constructor(coursesService, route, authService, categoryService) {
        this.coursesService = coursesService;
        this.route = route;
        this.authService = authService;
...
let AuthService = class AuthService {
    ...
    registerUser(id, fullName, username, email, contact, password, isAdmin) {
        const userData = {
            id,
            fullName,
            username,
    ...
    login(email, password) {
        ...
        this.http
            ...
            if (token) {
                ...
                this.saveAuthData(token, expirationDate, this.userId, this.fullName, this.username, this.contact, this.email, this.isAdmin, this.returnUrl);
    ...
    // tslint:disable-next-line: max-line-length
    saveAuthData(token, expirationDate, userId, fullName, username, contact, email, isAdmin, returnUrl) {
...
let CheckoutComponent = class CheckoutComponent {
    constructor(coursesService, fb, router, authService) {
        this.coursesService = coursesService;
        this.fb = fb;
        this.router = router;
        this.authService = authService;
    ...
    doCheckout() {
        const order = Object.assign({}, this.checkoutForm.value, { items: this.cart });
...
const BACKEND_URL = _jayem_1009_src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/contactsus/';
let ContactUsService = class ContactUsService {
    ...
    getContactsUs() {
        this.http
            .get(BACKEND_URL)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((contactusData) => {
    ...
    addContactUs(title, content) {
        const contactus = { id: null, title, content };
        this.http
...
let CourseDetailsComponent = class CourseDetailsComponent {
    constructor(coursesService, route, router) {
        this.coursesService = coursesService;
        this.route = route;
        this.router = router;
        this.courses = [];
...
const BACKEND_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + '/courses/';
...
const BACKEND_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/courses/';
let CoursesService = class CoursesService {
    ...
    fetchCourses() {
        this.http
            .get(BACKEND_URL)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((courseData) => {
    ...
    addCourse(name, category, description, price, image) {
    ...
    updateCourse(id, name, category, description, price, image) {
        let courseData;
...
/* harmony import */ var _angular_material_tree__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @angular/material/tree */ "./node_modules/@angular/material/esm2015/tree.js");
...
const BACKEND_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/enquiries/';
let EnquiryService = class EnquiryService {
    ...
    getEnquiries() {
        this.http
            .get(BACKEND_URL)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((enquiryData) => {
    ...
    addEnquiry(firstName, lastName, email, content) {
        const enquiry = { id: null, firstName, lastName, email, content };
        this.http
...
let CreateFeedbackComponent = class CreateFeedbackComponent {
...
CreateFeedbackComponent.ctorParameters = () => [
...
let FeedbackListComponent = class FeedbackListComponent {
    constructor(feedbacksService, authService) {
...
const BACKEND_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/feedbacks';
let FeedbackService = class FeedbackService {
    ...
    getFeedbacks() {
        this.http
            .get(BACKEND_URL)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(feedbackData => {
    ...
    addFeedback(title, content) {
        const feedback = { id: null, title, content };
        this.http
    ...
    updateFeedback(id, title, content) {
        const feedback = {
            id,
            title,
            content,
...
const BACKEND_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + '/messages/';
...
let OrderSuccessComponent = class OrderSuccessComponent {
    constructor(http, ordersService) {
        this.http = http;
        this.ordersService = ordersService;
        this.orders = [];
    }
...
const BACKEND_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + '/orders/';
...
/** @title Responsive sidenav */
let CreatePostsComponent = class CreatePostsComponent {
...
CreatePostsComponent.ctorParameters = () => [
...
let ListPostsComponent = class ListPostsComponent {
...
ListPostsComponent.ctorParameters = () => [
...
let PostsService = class PostsService {
    ...
    addPost(title, content, creator, createdAt, author) {
        const post = { id: null, title, content, creator, createdAt, author };
        this.http
    ...
    updatePost(id, title, content, createdAt, author) {
        const post = {
            id,
            title,
            content,
...
const BACKEND_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + '/user/';
let UserService = class UserService {
    ...
    getUsers() {
        this.http
            .get(BACKEND_URL)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((userData) => {
    ...
    // }
    addUser(fullName, username, email, isAdmin, contact, image) {
    ...
    updateUser(id, fullName, username, email, isAdmin, contact, image) {
        let userData;
        if (typeof image === 'object') {
